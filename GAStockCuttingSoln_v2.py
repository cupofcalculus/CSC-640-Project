...
NUMBER_OF_GENERATIONS = 3000 # HARDCODED Number of generations of evolution
        ...
        for shape2 in individual:
            ...
            if shape1_color != shape2_color:
                ...
                if shape_pair not in indiv_set:
                    ...
                    # If shape overlaps to the LEFT. 
                    # If shape overlaps to the RIGHT

                    if (lengthS1[0] <= lengthS2[1]<= lengthS1[1]) or (lengthS1[0] <= lengthS2[0]<= lengthS1[1]) or (lengthS2[0] <= lengthS1[0] and lengthS1[1] <= lengthS2[1]):
                        ...
                        if (heightS1[0] <= heightS2[1]<= heightS1[1]) or (heightS1[0] <= heightS2[0]<= heightS1[1]):
                            ...
                            # If second shape is just Right & exactly above.
                            ...
                            # If shape2 overlaps below and past both edges of shape1
                            elif ((heightS1[0] <= heightS2[0] <= heightS1[1]) and (lengthS2[0] <= lengthS1[0]) and (lengthS1[1]<= lengthS2[1])):
                                length_overlap = lengthS1[1] - lengthS1[0]
                                height_overlap = heightS1[1] - heightS2[0]
                                overlap_area = height_overlap * length_overlap

                            # If shape2 overlaps above and past both edges of shape1
                            elif ((heightS2[0] <= heightS1[0] <= heightS2[1]) and (lengthS2[0] <= lengthS1[0]) and (lengthS1[1]<= lengthS2[1])):
                                length_overlap = lengthS1[1] - lengthS1[0]
                                height_overlap = heightS2[1] - heightS1[0]
                                overlap_area = height_overlap * length_overlap
